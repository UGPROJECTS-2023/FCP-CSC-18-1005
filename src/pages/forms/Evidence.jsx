  ...
  return (
    ...
    <div id="loss-document" ref={inputRef} className="w-[500px] flex justify-start px-4">
      <div className="flex flex-col justify-start items-start  space-y-2">
        ...
        <p className="text-md font-semibold text-dark capitalize ml-40">
          (Security Divison)
        </p>
        <div className="flex flex-col space-y-2">
          ...
          <div className="flex flex-col space-y-2 justify-start px-4">
            ...
            <p className="text-md text-dark ml-12">this serve as a temporary ID Card tot he above named student.</p>
            <div className="py-6 flex flex-col space-y-2 ml-12">
              <p className="text-xl text-dark font-bold text-start ml-12 capitalize py-4">Security Division</p>
